...
const AboutUs = () => {
    return (
        <div>
            ...
            <div className="mt-10">
                <h1 className="text-xl font-medium">Why Choose The Book Vibe?</h1>
            ...
            <div className="mt-10 space-y-4">
                <h1 className="text-xl font-medium ">Join Our Literary Adventure</h1>
                <p>Whether you’re a seasoned reader or just starting your bookish journey, The Book Vibe is your haven. Explore our collection, connect with fellow readers, and embark on new reading adventures. Your next literary gem is just a click away</p>
                <p>So, come on in and be part of our book-loving family. Let’s turn the pages of amazing stories together!</p>
            </div>
        </div>
    );
};
